...
with holder_box_container.container():
    ...
    sample_size = col3.number_input("Sample Size:",value=5,min_value=0)
    failure_input = col1.number_input("Enter Number of Failures:",value=0,min_value=0)
    beta_input = col2.number_input("Enter β value (Weibull Shape):",value=1.5,min_value=0.00)
